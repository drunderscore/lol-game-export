...
CASTER_GOLD = 21
MELEE_GOLD = 27
SHARE_MULT_LASTHIT = 0.3
SHARE_MULT_MISS = 0.6
CANNON_SHARE_LASTHIT = SHARE_MULT_LASTHIT * CANNON_GOLD
CANNON_SHARE_MISS = SHARE_MULT_MISS * CANNON_GOLD
CASTER_SHARE_LASTHIT = SHARE_MULT_LASTHIT * CASTER_GOLD
CASTER_SHARE_MISS = SHARE_MULT_MISS * CASTER_GOLD
MELEE_SHARE_LASTHIT = SHARE_MULT_LASTHIT * MELEE_GOLD
MELEE_SHARE_MISS = SHARE_MULT_MISS * MELEE_GOLD
...
MeleeDefaultMinionInfo = {
  ...
  ExpUpgrade = 0,
  ExpInhibitor = 0,
  GoldGiven = MELEE_GOLD,
  GoldBonus = 0,
  GoldUpgrade = 1,
  GoldInhibitor = 0,
  GoldShared = 0,
  GoldShareUpgrade = 0,
  LocalGoldGivenOnLastHit = MELEE_SHARE_LASTHIT,
  GoldMaximumBonus = 0,
  LocalGoldGiven = 0,
  LocalGoldBonus = MELEE_SHARE_MISS,
...
CasterDefaultMinionInfo = {
  ...
  GoldMaximumBonus = 0,
  LocalGoldGiven = 0,
  LocalGoldGivenOnLastHit = CASTER_SHARE_LASTHIT,
  LocalGoldBonus = CASTER_SHARE_MISS,
  MoveSpeedBaseIncrease = 0
}
CannonDefaultMinionInfo = {
  ...
  GoldMaximumBonus = 33,
  LocalGoldGiven = 0,
  LocalGoldGivenOnLastHit = CANNON_SHARE_LASTHIT,
  LocalGoldBonus = CANNON_SHARE_MISS,
  MoveSpeedBaseIncrease = 0
}
...
OrderAwesomeMinionInfo = {
  MinionName = "URF_OrderMinionAwesome",
  DefaultInfo = AwesomeDefaultMinionInfo
}
ChaosAwesomeMinionInfo = {
  MinionName = "URF_ChaosMinionAwesome",
  DefaultInfo = AwesomeDefaultMinionInfo
}
DefaultBarrackInfo = {
  IsDestroyed = false,
...
DefaultOrderMinionInfoTable = {
  ...
  Awesome = OrderAwesomeMinionInfo
}
DefaultChaosMinionInfoTable = {
  ...
  Awesome = ChaosAwesomeMinionInfo
}
...
function GetMinionSpawnInfo(A0_99, A1_100, A2_101, A3_102, A4_103)
  ...
  if SPECIAL_MINION_MODE ~= "None" and GetWorldVar("URF_BaronTeam") then
    SPECIAL_MINION_MODE = "Awesome"
  end
  ...
  elseif SPECIAL_MINION_MODE == "None" then
    ClearCurrentWaveCounts(L5_104.MinionInfoTable)
  elseif SPECIAL_MINION_MODE == "Awesome" and GetWorldVar("URF_BaronTeam") == A3_102 then
    ClearCurrentWaveCounts(L5_104.MinionInfoTable)
    if A3_102 == TEAM_ORDER and totalNumberOfChaosBarracks == 0 or A3_102 == TEAM_CHAOS and totalNumberOfOrderBarracks == 0 then
      L5_104.MinionInfoTable.Awesome.NumPerWave = 2
    else
      L5_104.MinionInfoTable.Awesome.NumPerWave = 1
    end
  end
