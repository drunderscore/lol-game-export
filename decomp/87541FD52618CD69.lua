...
function L0_0()
  ...
  if string.lower(GetCharacterData().Name) == "sru_dragon" or string.lower(GetCharacterData().Name) == "sru_dragon_air" or string.lower(GetCharacterData().Name) == "sru_dragon_earth" or string.lower(GetCharacterData().Name) == "sru_dragon_elder" or string.lower(GetCharacterData().Name) == "sru_dragon_fire" or string.lower(GetCharacterData().Name) == "sru_dragon_water" then
...
function L0_0()
  ...
  if (L0_4 == AI_PET_RETURN or L0_4 == AI_PET_HARDRETURN) and distanceToOwner <= GetPetReturnRadius(me) then
    NetSetState(AI_PET_IDLE)
    return
  end
  if not OwnerIsMoving() and (L0_4 == AI_PET_MOVE or L0_4 == AI_PET_ATTACKMOVE and bNoEnemiesNear) then
    NetSetState(AI_PET_IDLE)
    return
  end
