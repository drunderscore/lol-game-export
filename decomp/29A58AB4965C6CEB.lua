...
INACTIVE = L0_0
L0_0 = 90
HEALTH_RELIC_RESPAWN_TIME = L0_0
L0_0 = 60
HEALTH_RELIC_OUTER_SPAWN_TIME = L0_0
L0_0 = 105
HEALTH_RELIC_INNER_SPAWN_TIME = L0_0
L0_0 = {
  "HA_AP_HealthRelic",
  "AramSpeedShrine",
  "HA_FB_HealthRelic"
...
function L0_0()
  ...
  for L4_5 = 1, NUMBER_OF_CAMPS do
    ...
    L5_6 = NeutralMinionCamps
    L5_6 = L5_6[L4_5]
    L5_6.EmptyVisibilityToAll = true
  end
  if L0_1 == "ARAM" or L0_1 == "KINGPORO" then
    ...
    L1_2.GroupsRespawnTime = L2_3
    L1_2.GroupDelaySpawnTime = L2_3
    L1_2.CampLevel = 3
