...
RED_BLUE_OFFSET = 2
CAMP_TIME_OFFSET = 1
START_OF_GAME_ADDITIONAL_DELAY_CRAB = 34
START_OF_GAME_ADDITIONAL_DELAY_DRAGON = 333
START_OF_GAME_ADDITIONAL_DELAY_BARON = 513
ELEMENTAL_DRAGON_SPAWN_RATE = 720
ELDER_DRAGON_SPAWN_TIME = 0
...
function NeutralMinionDeath(A0_31, A1_32, A2_33, A3_34)
  ...
  if HasUnitTag(A1_32, {
    ...
    elseif GetUnitSkinName(A1_32) == "SRU_Dragon_Elder" then
      ...
      NeutralMinionCamps[DRAGON_CAMP_INDEX].SkinID = SRUElderDragonSkinID
    end
  end
