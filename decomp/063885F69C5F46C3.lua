...
MINION_SPAWN_TIME_SCALE_START = 1080
MINION_SPAWN_TIME_SCALE_END = 1800
TIME_BETWEEN_MINION_WAVES_BASE = 25000
TIME_BETWEEN_MINION_WAVES_FINAL = 13000
MINION_MOVE_SPEED_INCREASE_START_TIME = 1080
MINION_MOVE_SPEED_INCREASE_CYCLE_TIME = 60
MINION_MOVE_SPEED_INCREASE_AMOUNT = 10
MINION_MOVE_SPEED_INCREASE_CURRENT_CYCLE = 0
MINION_MOVE_SPEED_INCREASE_MAX_CYCLES = 12
SpawnTable = {
  WaveSpawnRate = TIME_BETWEEN_MINION_WAVES_BASE,
...
function OnLevelInitServer()
  if GetGameMode() == "TUTORIAL" then
    ...
    InitTimer("UpgradeMinionMovementSpeedTimer", MINION_MOVE_SPEED_INCREASE_START_TIME, false)
...
function UpgradeMinionMovementSpeedTimer()
  if MINION_MOVE_SPEED_INCREASE_CURRENT_CYCLE < MINION_MOVE_SPEED_INCREASE_MAX_CYCLES then
    MINION_MOVE_SPEED_INCREASE_CURRENT_CYCLE = MINION_MOVE_SPEED_INCREASE_CURRENT_CYCLE + 1
    InitTimer("UpgradeMinionMovementSpeedTimer", MINION_MOVE_SPEED_INCREASE_CYCLE_TIME, false)
  end
end
...
function GetMinionSpawnInfo(A0_63, A1_64, A2_65, A3_66, A4_67)
  local L5_68, L7_69, L8_70, L9_71, L10_72
  L5_68 = 0
  L7_69 = 0
  L8_70 = TEAM_ORDER
  if A3_66 == L8_70 then
  ...
  L8_70 = L8_70.Melee
  L9_71 = L5_68.MinionInfoTable
  L9_71 = L9_71.Caster
  L10_72 = L5_68.MinionInfoTable
  L10_72 = L10_72.Super
  ...
  if GetGameTime() >= MINION_SPAWN_TIME_SCALE_END then
  elseif GetGameTime() >= MINION_SPAWN_TIME_SCALE_START then
  end
  SpawnTable.WaveSpawnRateOverride = (TIME_BETWEEN_MINION_WAVES_FINAL - TIME_BETWEEN_MINION_WAVES_BASE) * ((GetGameTime() - MINION_SPAWN_TIME_SCALE_START) / (MINION_SPAWN_TIME_SCALE_END - MINION_SPAWN_TIME_SCALE_START)) + TIME_BETWEEN_MINION_WAVES_BASE
  L10_72.MoveSpeedBaseIncrease, L5_68.MinionInfoTable.Cannon.MoveSpeedBaseIncrease, L9_71.MoveSpeedBaseIncrease, L8_70.MoveSpeedBaseIncrease = MINION_MOVE_SPEED_INCREASE_AMOUNT * MINION_MOVE_SPEED_INCREASE_CURRENT_CYCLE, MINION_MOVE_SPEED_INCREASE_AMOUNT * MINION_MOVE_SPEED_INCREASE_CURRENT_CYCLE, MINION_MOVE_SPEED_INCREASE_AMOUNT * MINION_MOVE_SPEED_INCREASE_CURRENT_CYCLE, MINION_MOVE_SPEED_INCREASE_AMOUNT * MINION_MOVE_SPEED_INCREASE_CURRENT_CYCLE
  ReturnTable = {
    NewFormat = true,
    ...
    WaveSpawnRateOverride = SpawnTable.WaveSpawnRateOverride,
