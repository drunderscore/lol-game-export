...
START_OF_GAME_ADDITIONAL_DELAY_BARON = 1113
ELEMENTAL_DRAGON_SPAWN_RATE = 360
ELDER_DRAGON_SPAWN_TIME = 2100
ELDER_DRAGON_SPAWN_RATE = 480
HOSTILE = 1
INACTIVE = 0
...
function NeutralMinionDeath(A0_31, A1_32, A2_33, A3_34)
  ...
  if GetUnitSkinName(A1_32) == "Sru_Crab" then
    ...
    CRAB_RANDOM_CHANCE = GetRandomIntInRangeLua(0, 100)
